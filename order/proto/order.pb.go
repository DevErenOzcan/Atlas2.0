...
const file_proto_order_proto_rawDesc = "" +
	...
	"\fOrderService\x12A\n" +
	"\n" +
	"ListOrders\x12\x18.order.ListOrdersRequest\x1a\x19.order.ListOrdersResponseB\n" +
...
var file_proto_order_proto_depIdxs = []int32{
	4, // 0: order.Order.create_date:type_name -> google.protobuf.Timestamp
	1, // 1: order.Order.order_details:type_name -> order.OrderDetail
	4, // 2: order.OrderDetail.create_date:type_name -> google.protobuf.Timestamp
